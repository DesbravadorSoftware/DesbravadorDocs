...
.pr-cover {
  position: relative;
  width: 100%;
  /* A4 297mm - margens ABNT (30+20) - header (~14mm) - footer (~10mm) */
  min-height: 223mm;
  display: flex;
...
</div>`}function h(S,g,P){return`
<div class="pr-section doc-section ${P?"":"pr-page-break"}">

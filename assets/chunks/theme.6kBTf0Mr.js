  ...
  <div class="pr-cover-body">
    ...
    <div class="pr-cover-meta">
      <div class="pr-cover-meta-item">
        ...
        <span class="pr-cover-meta-value">${P.docPages.map(A=>A.label).join(" · ")}</span>
      </div>
      <div class="pr-cover-meta-item">
...
<footer class="pr-page-footer">
  ...
  <span class="pr-ftr-page"></span>
</footer>`}async function P(){if(!(!o.value||n.value)){n.value=!0,await new Promise(k=>setTimeout(k,50));try{const k=p(),w=_(o.value),M=V(k),A=h(k),D=g(),E=ze(t.orientation,t.paperSize),B=window.open("","_blank","width=960,height=720");if(!B){alert("Permita pop-ups neste site para gerar o PDF.");return}B.document.write(`<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width,initial-scale=1">
